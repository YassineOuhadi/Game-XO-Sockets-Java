...
public class PlayerX {
	...
	private void initialize() {
		...
		final JLabel toplbl = new JLabel("Your are player X");
						...
						if(msg!=null) {
							...
							switch(msg) {
							  ...
							  case "btn9":
							    ...
							    break;
							  default:
								    if(msg.equals("start")){x=1;msg="Other player will start";};
